...
public final class MoveAnalysis {
    ...
    public boolean isAccepted() {
        return resultType == ResultType.SUCCESS_STANDARD 
                || resultType == ResultType.SUCCESS_CAPTURE
                || resultType == ResultType.SUCCESS_PROMOTION_REQUIRED 
                || resultType == ResultType.GAME_OVER_STALEMATE
                || resultType == ResultType.GAME_OVER_CHECKMATE;
    }
