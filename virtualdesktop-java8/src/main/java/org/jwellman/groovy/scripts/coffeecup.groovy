...
/* As of 12/31/2019, this script assumes you're using GraphicsPad which
 * is not working for some reason... possible resolutions might be ...
 * ... look for the original blog in the internet archives
 * ... need to include other graphicsbuilder jars from github archive
 * ... other?
 *
 */
antialias on
