...
In order to get 1.5.0 to work, I manually copied the demo code
from github into this project.  The license allows that.
*/
import org.jfree.chart.demo2.PieChartDemo1;
